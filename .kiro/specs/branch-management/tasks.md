...
- [ ] 1. Prisma schema: Add branch hierarchy models and modify existing models
  - [ ] 1.1 Add Country, Province, Branch, and UserBranchAssignment models to `apps/api/prisma/schema.prisma`
  ...
  - [ ] 1.2 Modify Assessment, StockItem, and User models
...
- [ ] 2. Backend: Country CRUD service and controller
  - [ ] 2.1 Create CountryService in `apps/api/src/modules/admin/branch-management/country.service.ts`
  ...
  - [ ] 2.3 Create CountryController in `apps/api/src/modules/admin/branch-management/country.controller.ts`
...
- [ ] 3. Backend: Province CRUD service and controller
  - [ ] 3.1 Create ProvinceService in `apps/api/src/modules/admin/branch-management/province.service.ts`
  ...
  - [ ] 3.3 Create ProvinceController in `apps/api/src/modules/admin/branch-management/province.controller.ts`
...
- [ ] 4. Backend: Branch CRUD service and controller
  - [ ] 4.1 Create BranchService in `apps/api/src/modules/admin/branch-management/branch.service.ts`
  ...
  - [ ] 4.3 Create BranchController in `apps/api/src/modules/admin/branch-management/branch.controller.ts`
...
- [ ] 5. Backend: UserBranch assignment service and controller
  - [ ] 5.1 Create UserBranchService in `apps/api/src/modules/admin/branch-management/user-branch.service.ts`
  ...
  - [ ] 5.3 Create UserBranchController in `apps/api/src/modules/admin/branch-management/user-branch.controller.ts`
...
- [ ] 6. Backend: Hierarchy service, controller, and module registration
  - [ ] 6.1 Create HierarchyService in `apps/api/src/modules/admin/branch-management/hierarchy.service.ts`
  ...
  - [ ] 6.3 Create HierarchyController in `apps/api/src/modules/admin/branch-management/hierarchy.controller.ts`
  ...
  - [ ] 6.4 Create BranchManagementModule and register in AdminModule
...
- [ ] 8. Backend: Modify AssessmentService for branch-scoped creation
  - [ ] 8.1 Update AssessmentService.create() to support branchId
...
- [ ] 9. Backend: Modify StockService for branchId propagation and filtering
  - [ ] 9.1 Update StockService.addToStock() to copy branchId from Assessment
    - When creating StockItem, copy `assessment.branchId` to `stockItem.branchId`
    - _Requirements: 5.2_

  - [ ] 9.2 Update StockService.findAll() to accept optional branchId filter
...
- [ ] 10. Backend: Modify DashboardService for branch-scoped metrics
  - [ ] 10.1 Update DashboardService.getMetrics() to accept optional branchId
